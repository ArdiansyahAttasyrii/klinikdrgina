                        ...
                        <tbody>
                            @foreach ($treatment as $item)
                                <tr>
                                   ...
                                   <td>
                                    <a href="{{ route('treatment.edit',$item->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                    <a href="{{ route('treatment.delete',$item->id) }}" onclick="return confirm('Apakah Anda Ingin Menghapus?');" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                   </td>
                                </tr>
                            @endforeach
                        </tbody>
